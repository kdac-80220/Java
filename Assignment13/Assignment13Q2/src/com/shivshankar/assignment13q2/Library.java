package com.shivshankar.assignment13q2;
...
class BookDetails implements Serializable{
	 String isbn;
	 double price; 
	 String authorName; 
	 int quantity;
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch(choise)
			{
				...
				case 8: try(FileOutputStream fout=new FileOutputStream("Books.txt"))
						{
						...
						break;
				case 9:	ArrayList<BookDetails> book;
						try(FileInputStream fin=new FileInputStream("Books.txt"))
						{
							try(ObjectInputStream oin=new ObjectInputStream(fin))
							{
								book=(ArrayList<BookDetails>)oin.readObject();
